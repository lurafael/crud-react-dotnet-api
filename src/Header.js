  ...
  render() {
    return (
      <header class="navbar navbar-expand-md navbar-dark bd-navbar">
        <link href="https://getbootstrap.com/docs/5.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous"></link>
        ...
        <nav class="container-xxl flex-wrap flex-md-nowrap" aria-label="Main navigation">
          ...
          <div class="collapse navbar-collapse" id="bdNavbar">
            <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav pt-2 py-md-0">
              ...
              <li class="nav-item col-6 col-md-auto">
                <a class="nav-link p-2" href="/clients">Clientes</a>
              </li>
            </ul>
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
              <li class="nav-item col-6 col-md-auto">
                <a class="nav-link p-2" href="https://github.com/lurafael" target="_blank" rel="noopener">
